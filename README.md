...
**Director of Design (DoD):** The Director of Design is responsible for educating veteran and newbie members in key engineering and design methodologies, the use of CAD software, and team CAD standards. During the season, they lead the CAD of the robot and take major part in deciding major design changes as well as the robot archetype (with aid from other mechanism leaders). They ensure the CAD is up to date with the actual robot and utilize best design practices. In the offseason, they educate members and suggest new concepts to experiment. In addition, they will organize design competitions and ensure all members are knowledgeable in CAD.

**Directors of Machining(DoM & ADoM):** Directors of Machining(DoM & ADoM): There are three leadership positions total, one for each section of the machining department (Waterjet; CNC and Laser Cutter; Bridgeport, Lathe, and other miscellaneous machines). Two of these positions are the ADoM, while the DoM position is for one qualified member who is specialized in at least one machining section and is willing to learn/has experience in the other machining sections. The DoM's primary responsibility is to supervise the machining subcategories while leading their respective sections of machining, while also providing feedback to other ADoMs and members of their respective sections. The DoM represents machining as a whole when it comes to general discussions and final decisions.

Each individual leader is responsible for making sure that all machines are maintained, used correctly, and able to function at a high performance. They must ensure that there are at least three members who have extensive experience with each machine, and are able to use them on demand, on a regular basis. They are also responsible for leading and initiating research and development projects to improve the team's machining capabilities, as well as implementing an organized education system to train anyone interested in machining.
